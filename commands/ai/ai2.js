...
// â”€â”€ Dead as of 2026-06 (removed): siputzx (all endpoints), ryzendesu (bot-protected),
//    giftedtech (ENOTFOUND), lance-frank (dead), letmegpt (400), paxsenix (ENOTFOUND)
// â”€â”€ Live: ch.at (~400ms), pollinations.ai text (~3-5s)
...
async function askAI(prompt) {
    ...
    return result || 'âš ï¸ AI servers are busy right now. Please try again in a moment.';
}
