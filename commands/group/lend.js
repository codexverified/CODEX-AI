...
// Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬ Pair code fetch Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
...
module.exports = {
    ...
    category: 'group',
    description: 'Lend the bot to a user Ã¢â‚¬â€ requests owner approval then delivers a pair code',
    ...
    run: async (sock, message, args, ctx) => {
        ...
        // Ã¢â€â‚¬Ã¢â€â‚¬ .lendlist Ã¢â‚¬â€ owner only Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
        if (rawCmd === 'lendlist') {
            if (!isOwner) return reply(fmt('Ã¢â€ºâ€ Only the owner can view the lend list.'));
            const pending  = Object.values(db.pending);
            const approved = Object.values(db.approved);
            if (!pending.length && !approved.length) {
                return reply(fmt('Ã°Å¸â€œâ€¹ *Lend List*\n\nNo pending or active lend requests.'));
            }
            ...
            const aLines = approved.map(r =>
                `Ã¢Å“â€¦ *${r.requestorName}* (+${r.requestorNum}) Ã¢â€ â€™ +${r.targetNumber}\n   _Approved: ${new Date(r.approvedAt).toLocaleString()}_`
            ).join('\n');
            return reply(fmt(
                `Ã°Å¸â€œâ€¹ *Lend Registry*\n\n` +
                (pLines ? `*Pending (${pending.length}):*\n${pLines}\n\n` : '') +
                (aLines ? `*Active (${approved.length}):*\n${aLines}` : '')
            ));
        }
 
        // Ã¢â€â‚¬Ã¢â€â‚¬ .lendstatus Ã¢â‚¬â€ check own request Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
        if (rawCmd === 'lendstatus') {
            const mine = db.pending[senderNum] || db.approved[senderNum] || db.rejected[senderNum];
            if (!mine) return reply(fmt('Ã¢â€žÂ¹Ã¯Â¸Â You have no lend request on record.\n\nUse `.lend 2547XXXXXXXX` to request.'));
            const status = db.approved[senderNum] ? 'Ã¢Å“â€¦ Approved'
                         : db.rejected[senderNum] ? 'Ã¢ÂÅ’ Rejected'
                         : 'Ã¢ÂÂ³ Pending owner approval';
            return reply(fmt(
                `Ã°Å¸Â¤Â *Your Lend Request*\n\n` +
        ...
        // Ã¢â€â‚¬Ã¢â€â‚¬ .approvelend Ã¢â‚¬â€ owner only Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
        // Usage: .approvelend <number> [7d|24h|30d]
        if (rawCmd === 'approvelend') {
            if (!isOwner) return reply(fmt('Ã¢â€ºâ€ Only the owner can approve lend requests.'));
            ...
            if (!numArg) {
                const pending = Object.values(db.pending);
                if (!pending.length) return reply(fmt('Ã°Å¸â€œâ€¹ No pending lend requests.'));
                const list = pending.map((r, i) =>
                    `${i+1}. *${r.requestorName}* (+${r.requestorNum}) Ã¢â€ â€™ for +${r.targetNumber}`
                ).join('\n');
                return reply(fmt(
                    `Ã°Å¸â€œâ€¹ *Pending Requests:*\n\n${list}\n\n` +
                    `_Use:_ \`.approvelend <number>\`\n` +
                    `_With expiry:_ \`.approvelend <number> 7d\``
                ));
            }
 
            // Ã¢â€â‚¬Ã¢â€â‚¬ Sub-bot limit check Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
            if (settings.maxSubBots > 0) {
                const activeCount = Object.keys(db.approved).length;
                if (activeCount >= settings.maxSubBots) {
                    return reply(fmt(
                        `Ã¢â€ºâ€ *Sub-bot limit reached!*\n\n` +
            ...
            if (!record) return reply(fmt(`Ã¢Å¡Â Ã¯Â¸Â No pending request found for +${numArg}.`));
            ...
            await reply(fmt(`Ã¢ÂÂ³ Approved! Starting sub-bot connection for +${record.targetNumber}Ã¢â‚¬Â¦`));
            ...
            try {
                ...
                const expiryNote = expiryMs
                    ? `Ã¢ÂÂ° *Expires in:* ${formatDuration(expiryMs)}`
                    : `Ã¢ÂÂ° *Expires:* Never (permanent until revoked)`;
                ...
                await reply(fmt(
                    ...
                    `They must enter it in WhatsApp Ã¢â€ â€™ Linked Devices within 60 seconds.\n\n` +
                    `_Once linked, the sub-bot goes live automatically._`
                ));
 
            } catch (err) {
                reply(fmt(`Ã¢ÂÅ’ Failed to start sub-bot: ${err.message}`));
            }
            return;
        }
 
        // Ã¢â€â‚¬Ã¢â€â‚¬ .rejectlend Ã¢â‚¬â€ owner only Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
        if (rawCmd === 'rejectlend') {
            if (!isOwner) return reply(fmt('Ã¢â€ºâ€ Only the owner can reject lend requests.'));
            ...
            if (!record) return reply(fmt(`Ã¢Å¡Â Ã¯Â¸Â No pending request found for +${targetNum}.`));
            ...
            return reply(fmt(`Ã¢ÂÅ’ Request from *${record.requestorName}* (+${record.requestorNum}) rejected.`));
        }
 
        // Ã¢â€â‚¬Ã¢â€â‚¬ .revokelend Ã¢â‚¬â€ owner only Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
        if (rawCmd === 'revokelend') {
            if (!isOwner) return reply(fmt('Ã¢â€ºâ€ Only the owner can revoke lends.'));
            const targetNum = args.join('').replace(/\D/g, '');
            ...
            if (!matchKey) return reply(fmt(`Ã¢Å¡Â Ã¯Â¸Â No active lend found for +${targetNum}.`));
            ...
            save(db);
            return reply(fmt(`Ã¢Å“â€¦ Lend for +${record.targetNumber} (owned by +${record.requestorNum}) revoked and sub-bot stopped.`));
        }
 
        // Ã¢â€â‚¬Ã¢â€â‚¬ .lend Ã¢â‚¬â€ request to lend bot Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
        if (rawCmd === 'lend') {
            const rawNumber = args.join('').replace(/\D/g, '');
 
            if (!rawNumber) {
                return reply(fmt(
                    `Ã°Å¸Â¤Â *Bot Lend / Session Request*\n\n` +
                    ...
                    `*Process:*\n` +
                    `1Ã¯Â¸ÂÃ¢Æ’Â£ Send \`.lend <your number>\`\n` +
                    `2Ã¯Â¸ÂÃ¢Æ’Â£ Owner reviews your request\n` +
                    `3Ã¯Â¸ÂÃ¢Æ’Â£ If approved, bot sends you a pair code\n` +
                    `4Ã¯Â¸ÂÃ¢Æ’Â£ Enter the code in WhatsApp Ã¢â€ â€™ Linked Devices\n\n` +
            ...
            if (db.pending[senderNum]) {
                return reply(fmt(
                    `Ã¢ÂÂ³ *You already have a pending request.*\n\n` +
            ...
            if (db.approved[senderNum]) {
                return reply(fmt(
                    `Ã¢Å“â€¦ *You already have an approved lend.*\n\n` +
            ...
            try {
                await sock.sendMessage(ownerJid, {
                    text: fmt(
                        `Ã°Å¸Â¤Â *New Bot Lend Request*\n\n` +
                        `Ã°Å¸â€˜Â¤ *From:* ${pushName} (+${senderNum})\n` +
                        `Ã°Å¸â€œÅ¾ *For number:* +${rawNumber}\n` +
                        `Ã°Å¸â€¢Â *Time:* ${new Date().toLocaleString()}\n\n` +
                        `*Actions:*\n` +
                        `Ã¢Å“â€¦ Approve: \`.approvelend ${senderNum}\`\n` +
                        `Ã¢ÂÅ’ Reject:  \`.rejectlend ${senderNum}\`\n\n` +
            ...
            return reply(fmt(
                `Ã¢Å“â€¦ *Lend Request Submitted!*\n\n` +
                `Ã°Å¸â€œÅ¾ Number: +${rawNumber}\n` +
                `Ã¢ÂÂ³ Status: *Pending owner approval*\n\n` +
