...
module.exports = {
    ...
    category: 'group',
    description: 'Silently mention all group members â€” they get notified but are not visibly tagged',
    ...
    run: async (sock, message, args, ctx) => {
        ...
        if (!isBotAdmin) {
            return sock.sendMessage(jid, {
                text: fmt(theme.botAdmin || 'â›” I need to be an admin to use hidetag.'),
                contextInfo
            }, { quoted: message });
        }
        ...
        // mentions array tags everyone silently â€” names don't appear in the message text
