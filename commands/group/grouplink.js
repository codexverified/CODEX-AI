...
module.exports = {
    ...
    run: async (sock, message, args, ctx) => {
        ...
        if (!isAdmin) {
            return sock.sendMessage(jid, { text: theme.admin || 'â›” Only admins can use this command.', contextInfo }, { quoted: message });
        }
        if (!isBotAdmin) {
            return sock.sendMessage(jid, { text: theme.botAdmin || 'â›” I need to be an admin to manage the invite link.', contextInfo }, { quoted: message });
        }
