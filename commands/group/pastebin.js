...
// hastebin.com is dead (connection refused) â€” removed.
    ...
    run: async (sock, message, args, { sender, contextInfo }) => {
        ...
        if (!text) {
            return sock.sendMessage(sender, {
                text: 'ðŸ“‹ Please provide text to paste.\nExample: `.paste Hello World`\n_Or reply to a message with `.paste`_',
                contextInfo
            }, { quoted: message });
        }
 
        await sock.sendMessage(sender, { text: 'â³ Uploading paste...', contextInfo }, { quoted: message });
 
        // Strategy 1: paste.rs â€” simple PUT, returns URL in body
        try {
            ...
            if (link.startsWith('https://')) {
                return sock.sendMessage(sender, {
                    text: `ðŸ“‹ *Paste Uploaded!*\n\nðŸ”— ${link}\n\n_paste.rs â€¢ No expiry_`,
                    contextInfo
                }, { quoted: message });
            }
        } catch {}
        ...
        try {
            ...
            if (link.startsWith('http')) {
                return sock.sendMessage(sender, {
                    text: `ðŸ“‹ *Paste Uploaded!*\n\nðŸ”— ${link}\n\n_dpaste.org â€¢ Expires in 30 days_`,
                    contextInfo
                }, { quoted: message });
            }
        } catch {}
