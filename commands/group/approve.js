...
// read as "how many pending requests to approve", not a number to look up.
...
module.exports = {
    ...
    category: 'group',
    reactions: { start: '📸' },
    description: 'Approve all pending group join requests, .approve <number> for just one, or .approve <count> (e.g. .approve 20) for the first N pending.',
    groupOnly: true,
    adminOnly: true,
    ...
    async execute(bot, m, args) {
        try {
            ...
            if (target) {
                ...
                // .approve 50 / .approve 20 — approve up to that many
            ...
            // No argument at all — original behaviour, approve everyone pending.
