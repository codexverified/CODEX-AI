 ...
 * ✅ Same text/link/image/video/audio/document + background color support as .gcstatus
 *
 * Usage:
 ...
 *   .gclinkstatus Hello everyone!|bg:blue
 ...
 *   — or any raw hex code like #FF00AA, using bg:.
 */
...
Usage:
${bot.prefix}gclinkstatus https://chat.whatsapp.com/XXXXXXXX Hello world!
${bot.prefix}gclinkstatus Hello everyone!|bg:blue   (reply to a message containing the link)
...
Colors: use bg: with named colors or raw hex codes, e.g. bg:blue`
        ...
        const { text: parsedText, backgroundColor } = parsePipeArgs(targetInfo.strippedRaw);
