    ...
    run: async (sock, message, args, { sender, contextInfo }) => {
        ...
        if (!target) {
            return sock.sendMessage(sender, {
                text: 'ðŸŽžï¸ Reply to a sticker or video with .togif to convert it to GIF.',
                contextInfo
            }, { quoted: message });
        }
        await sock.sendMessage(sender, { text: 'â³ Converting to GIF...', contextInfo }, { quoted: message });
        try {
            ...
            await sock.sendMessage(sender, { text: `âŒ GIF conversion failed: ${e.message}`, contextInfo }, { quoted: message });
        }
    }
};
