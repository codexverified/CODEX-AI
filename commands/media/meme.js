...
// meme-api.com is dead (500 errors / no response) â€” removed.
    ...
    run: async (sock, message, args, ctx) => {
        ...
        try {
            ...
            await sock.sendMessage(jid, {
                image:   { url: meme.url },
                caption: `ðŸ˜‚ *${meme.title.slice(0, 150)}*\n\nðŸ‘¤ u/${meme.author}  â€¢  r/${meme.subreddit}  â€¢  ðŸ‘ ${(meme.ups || 0).toLocaleString()}`,
                contextInfo
            }, { quoted: message });
            return;
        } catch {}
        ...
        await sock.sendMessage(jid, {
            text: `ðŸ˜‚ Couldn't fetch a meme right now. Try again or check r/memes:\nhttps://www.reddit.com/r/memes`,
            contextInfo
        }, { quoted: message });
    }
};
