...
module.exports = {
    ...
    async execute(bot, m, args) {
        ...
        try {
            ...
            await bot.sendMessage(m.chat, { react: { text: '', key: m.key } }).catch(() => {});
            return m.reply('Could not download that sticker. Try forwarding it once and retry.');
        }
            ...
            try {
                ...
                try {
                    await bot.sendMessage(m.chat, {
                        ...
                        caption: 'ffmpeg unavailable — sent as raw animated WebP.',
                    }, { quoted: m });
                    await bot.sendMessage(m.chat, { react: { text: '', key: m.key } }).catch(() => {});
                } catch (_) {
                    await bot.sendMessage(m.chat, { react: { text: '', key: m.key } }).catch(() => {});
                    await m.reply('Failed to convert animated sticker.');
                }
                return;
            }
        }
