...
// In-memory toggle â€” seeded from config, changeable at runtime
    ...
    run: async (sock, message, args, { sender, contextInfo }) => {
        ...
        if (!quoted) {
            return sock.sendMessage(sender, {
                text: 'âŒ *Reply to a view-once photo / video / audio with this command.*',
                contextInfo
            }, { quoted: message });
        }
        ...
        if (!type) {
            return sock.sendMessage(sender, {
                text: 'âŒ Quoted message has no image, video, or audio.',
                contextInfo
            }, { quoted: message });
        }
        ...
        try {
            ...
            await sock.sendMessage(sender, { react: { text: 'ðŸ˜”', key: message.key } });
            await sock.sendMessage(sender, {
                text: `âŒ Failed to open media: ${err.message}`,
                contextInfo
            }, { quoted: message });
        }
    }
