...
module.exports = {
    ...
    run: async (sock, message, args, ctx) => {
        ...
        if (!isAdmin) return reply(fmt('â›” Only admins can mute/unmute members.'));
        ...
        // â”€â”€ mutelist â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        if (rawCmd === 'mutelist') {
            if (!muteSet.size) return reply(fmt('ðŸ“‹ No muted members in this group.'));
            const lines = [...muteSet].map(j => `â€¢ @${j.split('@')[0]}`).join('\n');
            return sock.sendMessage(jid, {
                text: fmt(`ðŸ”‡ *Muted Members (${muteSet.size}):*\n\n${lines}`),
                mentions: [...muteSet],
                contextInfo,
            }, { quoted: message });
        }
 
        // â”€â”€ mute / unmute â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        ...
        if (!target) {
            return reply(fmt(
                rawCmd === 'mute'
                    ? 'âŒ Reply to a message or mention someone to mute them.'
                    : 'âŒ Reply to a message or mention someone to unmute them.'
            ));
        }
        ...
        if (isTargetAdmin && rawCmd === 'mute') {
            return reply(fmt(`âŒ Cannot mute @${num} â€” they are an admin.`));
        }
 
        if (rawCmd === 'mute') {
            muteSet.add(target);
            return sock.sendMessage(jid, {
                text: fmt(`ðŸ”‡ @${num} has been *muted*.\nTheir messages will be automatically deleted.`),
                mentions: [target],
                contextInfo,
            }, { quoted: message });
        }
        ...
        if (rawCmd === 'unmute') {
            ...
            return sock.sendMessage(jid, {
                text: fmt(`ðŸ”Š @${num} has been *unmuted*.`),
                mentions: [target],
                contextInfo,
            }, { quoted: message });
        }
