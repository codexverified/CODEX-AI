...
module.exports = {
    ...
    category: 'admin',
    description: 'Create a WhatsApp native poll â€” single or multi-select',
    ...
    run: async (sock, message, args, ctx) => {
        ...
        if (!isAdmin) {
            return sock.sendMessage(jid, {
                text: 'â›” Only admins can create polls.',
                contextInfo
            }, { quoted: message });
        }
        ...
        if (parts.length < 3) {
            return sock.sendMessage(jid, {
                text: 'âŒ You need a question and at least *2 options*.\n\nExample: `.poll Best fruit? | Apple | Mango | Banana`',
                contextInfo
            }, { quoted: message });
        }
