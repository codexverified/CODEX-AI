    ...
    run: async (sock, message, args, { sender, contextInfo }) => {
        ...
        if (!url || !url.includes('mediafire.com')) {
            return sock.sendMessage(sender, {
                text: 'âŒ Please provide a valid MediaFire URL.\nExample: .mf https://www.mediafire.com/file/abc/filename/file',
                contextInfo
            }, { quoted: message });
        }
        await sock.sendMessage(sender, { text: 'â³ Extracting MediaFire link...', contextInfo }, { quoted: message });
        try {
            ...
            await sock.sendMessage(sender, {
                text: `ðŸ“ *MediaFire Download*\n\nðŸ“„ *File:* ${fileName}\nðŸ”— *Link:* ${dlUrl}\n\n_Powered by CODEX AI_`,
                contextInfo
            }, { quoted: message });
        } catch (e) {
            await sock.sendMessage(sender, { text: `âŒ MediaFire failed: ${e.message}`, contextInfo }, { quoted: message });
        }
    }
};
