...
// nexoracle.com returns HTML (bot protection), not a usable API â€” removed.
...
module.exports = {
    ...
    run: async (sock, message, args, { sender, contextInfo }) => {
        ...
        try {
            // 1. Search YouTube for the song (play-dl â€” no external API)
            ...
            await deleteLoading();
            await sock.sendMessage(sender, {
                text: `âŒ Song download failed: ${String(e.message).slice(0, 100)}\n\n_Try: \`.ytmp3 <youtube url>\` with a direct URL_`,
                contextInfo
            }, { quoted: message });
        }
    }
