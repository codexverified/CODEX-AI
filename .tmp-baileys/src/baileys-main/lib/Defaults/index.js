...
export const DONATE_URL = 'https://github.com/CEO-CODEX/baileys-';
export const LIBRARY_NAME = '@codexverified/baileys';
...
export const WA_ADV_KEY_INDEX_LIST_SIG_PREFIX = Buffer.from([6, 2]);
export const WA_ADV_HOSTED_KEY_INDEX_LIST_SIG_PREFIX_VERIFY = true;
export const WA_ADV_HOSTED_KEY_INDEX_LIST_SIG_PREFIX = Buffer.from([6, 7]);
