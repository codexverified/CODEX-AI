...
const GTA_DB    = path.join(PROJECT_ROOT, 'database/gta.json');
const GANG_DB   = path.join(PROJECT_ROOT, 'database/gangs.json');
const TERR_DB   = path.join(PROJECT_ROOT, 'database/territories.json');
