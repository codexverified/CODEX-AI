/**
 * CJS ↔ ESM bridge for @codexverified/baileys (the fork this project
 * actually depends on — see package.json/pnpm-lock.yaml).
 *
 * Baileys v7+ ships as ESM-only, so `require('@codexverified/baileys')` throws
