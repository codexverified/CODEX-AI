...
class CommandHandler {
    ...
    wrapCommandReactions(command) {
        ...
        // Kept so lib/permit.js can inspect the command's real code (it refuses to
        // permit any command that checks owner/admin rights itself).
        command.__origExecute = originalExecute;
    ...
    loadPluginFile(filePath) {
        ...
        for (const definition of definitions) {
            ...
            this.wrapCommandReactions(command);
            command.__origExecute = definition.run; // see wrapCommandReactions()
