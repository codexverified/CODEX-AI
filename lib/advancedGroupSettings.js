...
// DND is intentionally NOT included — it's excluded from low/smart/hyper.
...
function applyMode(groupId, mode, maxWarns = 3) {
  ...
  for (const sys of SYSTEMS) {
    ...
    // banned-words list, antispam's limit/cooldown, ...) — only
    // enabled/action/maxWarns are touched here.
